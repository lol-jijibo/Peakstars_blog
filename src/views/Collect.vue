<template>
  <div class="simple-page">
    ...
    <template v-if="collectedArticles.length">
    ...
    <div v-else class="empty-state">
      ...
      <div class="empty-sub">快去文章列表收藏感兴趣的内容吧</div>
...
onMounted(async () => {
  try {
    const data = await getTechArticles({ category: 'collect', pageSize: 999 })
    collectedArticles.value = Array.isArray(data?.list) ? data.list : []
  } catch {
