export const interviews = [
  {
    ...
    avatar: 'B',
    avatarColor: '#e87722',
    summary: '虽然百度这几年发展势头落后于AT，甚至快被京东赶上了，毕竟瘦死的骆驼比马大，面试还是相当有难度和水准的...',
    content: `虽然百度这几年发展势头落后于AT，甚至快被京东赶上了，毕竟瘦死的骆驼比马大，面试还是相当有难度和水准的。
...
薪资待遇，工作强度，发展规划（正常聊即可）`,
    tags: ['前端', '百度', 'ES6', 'Vue', '算法']
  },
  {
    id: 2,
    title: '字节跳动前端面经（三轮技术面）',
    author: '不风流怎样倜傥',
    date: '2024-02-20',
    views: 3205,
    likes: 432,
    ...
    avatar: '字',
    avatarColor: '#1d7cfe',
    summary: '笔者读大三，前端小白一枚，正在准备春招，人生第一次面试，投了头条前端，总共经历了四轮技术面...',
    content: `笔者读大三，前端小白一枚，正在准备春招，人生第一次面试，投了头条前端，总共经历了四轮技术面，最终拿到了实习 offer，特此记录。
...
1. Vue 核心原理
   ...
   - 组件通信方式（props/$emit、$parent/$children、EventBus、Vuex、provide/inject）
...
聊职业规划、团队合作、对加班的看法`,
    tags: ['前端', '字节跳动', 'JavaScript', 'Vue', '算法']
  },
  {
    id: 3,
    title: '阿里巴巴 Java 后端面经',
    author: '醉卧九天',
    date: '2024-01-10',
    views: 4183,
    likes: 612,
    ...
    avatar: '阿',
    avatarColor: '#ff6a00',
    summary: '历经五轮面试终于拿下阿里 P6 offer，Java基础、JVM、并发、Spring、分布式样样不落...',
    content: `历经五轮面试终于拿下阿里 P6 offer，把面试过程完整记录下来供大家参考。
...
项目经历深挖 + 薪资谈判`,
    tags: ['Java', '阿里巴巴', 'JVM', 'Spring', 'MySQL', '分布式']
  },
  {
    id: 4,
    title: '腾讯前端面经（社招）',
    ...
    avatar: '腾',
    avatarColor: '#07c160',
    summary: '腾讯社招前端，岗位是互动娱乐事业群（IEG），整体难度偏高，更注重工程化和性能优化...',
    content: `腾讯社招前端，岗位是互动娱乐事业群（IEG），整体难度偏高，更注重工程化和性能优化。
...
**HR面**：聊期望薪资和职业规划`,
    tags: ['前端', '腾讯', 'React', 'Webpack', '性能优化']
  },
  {
    id: 5,
    title: '美团 Java 后端面经（校招）',
    author: '骑手逆袭',
    date: '2024-02-05',
    views: 2943,
    likes: 356,
    ...
    avatar: '美',
    avatarColor: '#ffc400',
    summary: '美团校招Java后端，公司风格务实，更注重基础扎实和项目实战经验...',
    content: `美团校招 Java 后端，公司风格务实，更注重基础扎实和项目实战经验，三轮技术面 + HR 面。
...
- 订单数据的冷热分离`,
    tags: ['Java', '美团', 'Redis', 'MySQL', 'Spring']
  },
  {
    id: 6,
    title: '网易前端面经（游戏部门）',
    ...
    avatar: '网',
    avatarColor: '#c0392b',
    summary: '网易互娱前端，重点考察 Canvas、WebGL 和游戏相关的前端技术，和普通业务前端方向有所不同...',
    content: `网易互娱前端，重点考察 Canvas、WebGL 和游戏相关的前端技术，和普通业务前端方向有所不同。
...
聊项目亮点，对游戏前端的理解，PixiJS/Three.js 的使用经验`,
    tags: ['前端', '网易', 'Canvas', 'TypeScript', '浏览器原理']
  },
  {
    id: 7,
    title: '京东 Java 后端面经（物流系统）',
    author: '搬砖工程师',
    date: '2024-02-28',
    views: 2341,
    likes: 298,
    ...
    avatar: '京',
    avatarColor: '#e1251b',
    summary: '京东物流技术部Java后端，偏向高并发、分布式系统，面试注重实际工程经验...',
    content: `京东物流技术部 Java 后端，偏向高并发、分布式系统，面试注重实际工程经验，问的都是实际场景题。
...
微服务拆分原则，服务网格（Service Mesh）了解多少，Istio 的功能`,
    tags: ['Java', '京东', '分布式', '微服务', 'Elasticsearch']
  },
  {
    id: 8,
    title: '滴滴前端面经（出行平台）',
    ...
    avatar: '滴',
    avatarColor: '#ff6000',
    summary: '滴滴出行前端，业务涉及地图、实时定位，面试既考基础也考工程实践，节奏较快...',
    content: `滴滴出行前端，业务涉及地图、实时定位，面试既考基础也考工程实践，节奏较快。
