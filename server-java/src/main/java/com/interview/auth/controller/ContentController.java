 ...
 * Controller 只负责维持统一的 code / message / data 响应结构，具体查询与转换交给 Service。
 */
@RestController
...
public class ContentController {
    ...
    /**
     * 提供技术文章模块列表接口，服务文章频道页和顶部导航预览。
     * 返回结果已经过后端字段转换，前端可以直接按现有结构渲染。
     */
    ...
    /**
     * 提供看天下期刊列表接口，服务看天下频道页。
     * 保持现有页面字段命名不变，降低前端切换后端数据源的改造量。
     */
    ...
    /**
     * 提供 AI 热点列表接口，服务热点流与最新流切换。
     * 推荐标记、发布时间和标签数组都在后端完成组织，前端只负责展示与筛选。
     */
